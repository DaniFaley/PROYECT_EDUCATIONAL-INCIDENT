...
<body>
    ...
    <div id="equipos" class="tabcontent" style="display:none">
        ...
        <div id="impresoras" class="equipment-tab" style="display:none">
            <div class="header-container">
                <a href="add_impresoras.html"><button class="buttonA">Agregar Impresoras</button></a>
            </div>
            <table>
                <tr>
                    <th>ID</th>
        ...
        <div id="proyectores" class="equipment-tab" style="display:none">
            <div class="header-container">
                <a href="add_proyectores.html"><button class="buttonA">Agregar Proyectores</button></a>
            </div>
            <table>
                <tr>
                    <th>ID</th>
        ...
        <div id="computadoras" class="equipment-tab"> style="display:none">
        <div class="header-container">
                <a href="add_computadoras.html"><button class="buttonA">Agregar Computadoras</button></a>
            </div>
            <table>
                <tr>
                    <th>ID</th>
